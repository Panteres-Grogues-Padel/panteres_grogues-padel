-- sancionar_jugador: notificació al jugador sancionat
...
BEGIN
  ...
  v_fins := to_char(p_fins, 'DD/MM/YYYY');
  ...
  VALUES (
    ...
    'sancio_aplicada',
    'Sanció aplicada',
    'Has estat sancionat/da fins al ' || v_fins || '. Contacta amb la coordinació si tens dubtes.',
    '{}'::jsonb
  );
